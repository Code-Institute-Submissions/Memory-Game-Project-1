...
- Bugs Documented
    - The game would think that matching colours are not matching and vice versa. 
        - FIX: Line 76 in main.js operator was set to === instead of !==. This simple change fixed the bug.
    - Game completely stopped responding
        - FIX: Forgot to update variable "secondSquare" to "hasSquareBeenClicked" on Line 40
